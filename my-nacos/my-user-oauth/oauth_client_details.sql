...
-- ----------------------------
INSERT INTO `oauth_client_details` VALUES ('changgou', 'app-resources', '$2a$10$wZRCFgWnwABfE60igAkBPeuGFuzk74V2jw3/trkdUZpnteCtJ9p9m', 'app', 'authorization_code,password,refresh_token,client_credentials,sms_code', 'http://localhost', NULL, 432000000, 432000000, NULL, NULL);
INSERT INTO `oauth_client_details` VALUES ('szitheima', 'app-resources', '$2a$10$igxoCZxTbjWx5TrmfWEEpe/WFdwbUhbxik9BKTe9i64ZOSfnu/lqe', 'app', 'authorization_code,password,refresh_token,client_credentials,sms_code', 'http://localhost', NULL, 432000000, 432000000, NULL, NULL);
