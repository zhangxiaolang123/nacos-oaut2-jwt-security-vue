...
public class UserController {
    ...
    public Result<PageInfo> search(@PathVariable int page, @PathVariable int size) {
  ...
  //  @PreAuthorize(value="hasAuthority('goods_list')")
    ...
    public PageInfo findPage(@RequestParam("pageNum") int pageNum ,@RequestParam("pageSize") int pageSize) {
